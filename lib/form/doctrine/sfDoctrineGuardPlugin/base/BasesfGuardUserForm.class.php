...
abstract class BasesfGuardUserForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'est_civil'         => new sfValidatorString(array('max_length' => 15)),
      'fotografia'        => new sfValidatorString(array('max_length' => 255, 'required' => false)),
